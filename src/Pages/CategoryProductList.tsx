        ...
        <>
            ...
            <section className='flex flex-col w-full py-12 bg-pureWhite lg:gap-y-24'>
                {products.map((product, index) => (
                    <div className={`flex ${index % 2 === 0 ? `lg:flex-row` : `lg:flex-row-reverse`} md:flex-row px-12 flex-col items-center justify-between w-full viewport gap-y-8 pb-16`}>
                        ...
                        <div className={`flex flex-col gap-y-[1rem] mx-auto lg:mx-0 px-8 max-w-[398px] text-center md:text-start items-start lg:items-start md:items-center`}>
                            {index === 0 && <p className="items-start uppercase text-overline text-darkOrange md:text-center text-start">
                                New Product
                            </p>}
                            ...
                            <Button
                                action="See Product"
                                link={`/${category}/${product.slug}`} variant="Solid"
