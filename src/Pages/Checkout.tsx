...
const Checkout = () => {
	...
	return (
		<div className='flex flex-col w-full px-4 bg-darkWhite'>
			...
			<Form {...form}>
				<form className='flex flex-col w-full mb-6 gap-y-8 min-[768px]:flex-row min-[768px]:gap-x-8 viewport' onSubmit={() => { console.log('Shopping Cart: ', shoppingCart) }}>
					<section className='w-full px-6 py-6 rounded-lg bg-pureWhite'>
						...
						<div className="flex flex-col items-start w-full mt-8 gap-y-4">
							<div className="flex flex-col items-center w-full gap-y-6">
								<p className='uppercase text-subtitle text-darkOrange col-span-1 [430px]:col-span-2 w-full'>Billing Details</p>
								<div className="grid w-full max-[430px]:grid-cols-1 min-[430px]:grid-cols-2 mb-6 gap-x-4 gap-y-6">
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input placeholder='e.g Kofi' className='px-4 py-5 mt-2' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input className='px-4 py-5 mt-2' placeholder='e.g alexei@mail.com' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input className='px-4 py-5 mt-2' placeholder='e.g +1 202-555-0136' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									...
									<p className='uppercase text-subtitle text-darkOrange col-span-1 min-[430px]:col-span-2 mt-8'>Shipping info</p>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input className='px-4 py-5 mt-2' placeholder='e.g 1137 Williams Avenue' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input className='px-4 py-5 mt-2' placeholder='e.g 10001' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input className='px-4 py-5 mt-2' placeholder='e.g New York' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='min-[430px]:col-span-1 col-span-2'>
												...
												<FormControl>
													<Input className='px-4 py-5 mt-2' placeholder='e.g United States' {...field} />
												</FormControl>
												<FormMessage />
											</FormItem>
										)}
									/>
									<p className='col-span-1 mt-8 uppercase text-subtitle text-darkOrange'> Payment Details</p>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className='grid grid-cols-2 col-span-2 max-[430px]:grid-cols-1'>
												<FormLabel className='col-span-1'>Payment Option</FormLabel>
												<FormControl className='col-span-1'>
													<RadioGroup defaultValue="delivery" onValueChange={field.onChange} value={field.value}>
														<div className={`flex items-center gap-3 border rounded-[8px] px-4 py-4 ${deliveryOpt && 'border-darkOrange'}`}>
															<FormControl>
									...
									/>
									{deliveryOpt && <div className='grid grid-cols-1 min-[430px]:grid-cols-2 min-[430px]:gap-x-4 gap-y-4 w-full'>
										<FormField
											control={form.control}
											name='country'
											render={({ field }) => (
												<FormItem className='w-full col-span-1'>
													...
													<FormControl>
														<Input className='px-4 py-5 mt-2' placeholder='e.g 238521993' {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem className='w-full col-span-1'>
													...
													<FormControl>
														<Input className='px-4 py-5 mt-2' placeholder='e.g 6891' {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
					...
					<section className='w-full px-6 py-6 rounded-lg bg-pureWhite min-[768px]:max-w-xs h-fit'>
						...
						<div className="flex flex-col mt-8 gap-y-2">
							<div className="flex flex-row justify-between">
								<p className='font-normal uppercase text-subtitle text-pureBlack/70'>Total</p>
								<p className='font-bold uppercase text-subtitle text-pureBlack'>
									<NumberFormat amount={calculateTotalPrice()} currency='USD' />
								</p>
							</div>
							<div className="flex flex-row justify-between">
								<p className='font-normal uppercase text-subtitle text-pureBlack/70'>Shipping</p>
								<p className='font-bold uppercase text-subtitle text-pureBlack'>
									<NumberFormat amount={shippingCost} currency='USD' />
								</p>
							</div>
							<div className="flex flex-row justify-between">
								<p className='font-normal uppercase text-subtitle text-pureBlack/70'>VAT (inlcuded)</p>
								<p className='font-bold uppercase text-subtitle text-pureBlack'>
							...
							<div className="flex flex-col mt-6 gap-y-6">
								<div className="flex flex-row justify-between">
									<p className='font-normal uppercase text-subtitle text-pureBlack/70'>Grand Total</p>
