            ...
            <DialogContent className='bg-pureWhite'>
                ...
                <div className="flex flex-row max-[430px]:flex max-[430px]:flex-col items-center w-full my-10 overflow-hidden rounded-lg">
                    <div className="flex flex-col w-full h-full p-6 bg-darkWhite gap-y-3">
                        ...
                        <p className='text-center text-[12px] font-bold text-pureBlack/50'> and {remainingProducts} other item(s)</p>
                    </div>
                    <div className="flex flex-col items-start justify-center w-full h-full gap-2 p-6 bg-pureBlack">
                        ...
                        <p className='uppercase text-h6 text-darkWhite'><NumberFormat amount={grandTotal} currency='USD' /></p>
                    </div>
                </div>
                <DialogClose className="px-8 py-3 uppercase duration-300 text-body text-pureWhite bg-darkOrange hover:bg-fadedOrange" onClick={() => navigate('/')}>
                    Back to Home
                </DialogClose>
            </DialogContent>
